...
<template>
    <GuestLayout>
        ...
        <div v-if="!submitted" class="w-[320px] xs:min-w-[360px] flex flex-col items-center justify-center gap-8">
        ...
        <div v-else class="w-[320px] xs:min-w-[360px] flex flex-col items-center justify-center gap-8">
            <div class="flex flex-col items-start gap-3 self-stretch">
